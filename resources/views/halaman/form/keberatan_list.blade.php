...
@php
    ...
    $statusClasses = [
        ...
        'Selesai' => ['dot' => 'bg-success', 'badge' => 'bg-success-subtle text-success-emphasis', 'pill' => 'bg-success-subtle text-success-emphasis', 'label' => 'Permohonan Keberatan Selesai'],
...
<div class="card border-0 shadow-sm bg-light-subtle">
    <div class="card-body p-4 p-md-4">
        <div class="d-flex align-items-center justify-content-between pb-3 border-bottom mb-4">
            <div>
                <p class="mb-1 text-uppercase small fw-bold text-secondary" style="letter-spacing: 0.18em;">Keberatan</p>
                <h3 class="mb-0 h4 fw-bold text-dark">Daftar Data Ajuan</h3>
            </div>
        </div>
                    ...
                    <div class="list-group overflow-hidden border rounded-3 shadow-sm">
                        ...
                        @forelse ($statusItems as $item)
                            @php
                                ...
                                $itemName = data_get($item, 'kode_ajuan') ?: data_get($item, 'nama') ?: 'Nama Pemohon';
                                $itemLabel = data_get($item, 'alasan_keberatan') ?: data_get($item, 'label') ?: 'Informasi';
                                $itemTitle = route('form.keberatan.detail',['id' => $item->kode_ajuan]);
                                ...
                                $itemUpdateUrl = route('ajuan.keberatan.update',['id'=>$item->id]);
