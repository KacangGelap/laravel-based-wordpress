        ...
        <div class="col-md-8">
            <div class="card">
                <div class="d-md-flex card-header justify-content-between">
                    <h4>{{ isset($data) ? __('Edit Dropdown') : __('Tambah Dropdown') }}</h4>
                    @php
                    ...
                    <form method="POST" action="{{$routeAction}}">
                        ...
                        <div class="row mb-3">
                            <label for="judul" class="col-md-4 col-form-label text-md-end">
                                Judul {{ Route::current()->getName() == 'submenu.create' || Route::current()->getName() == 'submenu.edit' ? 'Sub-Menu' : (Route::current()->getName() == 'subsubmenu.create' || Route::current()->getName() == 'subsubmenu.edit' ? 'Sub-Sub-Menu' : 'Sub-Sub-Sub-Menu') }}
                            </label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ isset($submenu) || isset($subsubmenu) || isset($subsubsubmenu) ? __('Update') : __('Tambah') }}
                                </button>
                            </div>
                        </div>
                    </form>
