        ...
        <div class="col-md-8">
            <div class="card">
                <div class="d-md-flex card-header justify-content-between">
                    <h4>{{ isset($data) ? __('Edit File') : __('Tambah File') }}</h4>
                    @php
                    ...
                    <form method="POST" action="{{$routeAction}}"  enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="judul" class="col-md-4 col-form-label text-md-end">
                                Judul {{ Route::current()->getName() == 'submenu.create' || Route::current()->getName() == 'submenu.edit' ? 'Sub-Menu' : (Route::current()->getName() == 'subsubmenu.create' || Route::current()->getName() == 'subsubmenu.edit' ? 'Sub-Sub-Menu' : (Route::current()->getName() == 'subsubmenu.create' || Route::current()->getName() == 'subsubmenu.edit' ? 'Sub-Sub-Sub-Menu' : 'Sub-Sub-Sub-Sub-Menu')) }}</label>
                            <div class="col-md-6">
                                <input id="judul" type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ $data->sub_menu ?? $data->sub_sub_menu ?? $data->sub_sub_sub_menu ?? $data->sub_sub_sub_sub_menu ??old('judul')  }}" {{!isset($data) ? 'required' : ''}}autocomplete="judul" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="pdf" class="col-md-4 col-form-label text-md-end">Masukkan File Pdf</label>

                            <div class="col-md-6">
                                <input id="pdf" type="file" class="form-control @error('pdf') is-invalid @enderror" name="pdf" value="{{ old('pdf') }}" {{!isset($data) ? 'required' : ''}} autocomplete="pdf" autofocus>
