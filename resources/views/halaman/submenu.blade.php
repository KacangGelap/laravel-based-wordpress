            ...
            <div class="card-body">
                <div class="">
                    ...
                    <div class="d-md-flex">
                        ...
                        @if($isExists === false)<a href="{{route('submenu.create',['menu' => $menu->id, 'tambah' => 3])}}" class="badge text-decoration-none text-bg-success mx-1"><i class="bi-diagram-3 me-1"></i>Identitas PD/UPT</a>@endif
