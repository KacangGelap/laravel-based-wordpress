        ...
        <div class="col-md-8">
            <div class="card">
                <div class="d-md-flex card-header justify-content-between">
                    <h4>{{'Ubah Gambar Galeri Geser'}}</h4>
                    <a href="{{ route('carousel.carousels', $data->category->id) }}" class="btn btn-dark">Kembali</a>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{route('carousel.update', $data->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3 justify-content-center">
                            <div class="col-md-8 card shadow-sm border border-dark position-relative">
                                ...
                                <label for="image" id="label-image" 
                                    ...
                                    style="height: 200px; cursor: pointer; background-image:url('/storage/{{$data->media}}'); background-size:cover; background-position:center; background-repeat:no-repeat;">
